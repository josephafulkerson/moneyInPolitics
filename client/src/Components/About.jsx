...
const About = () => {
    return (
        <div>
            ...
            <p>Our mission is to make you a more informed voter! Money has the power to influence legislation and even elections. By exploring our app you will be able to see where legislators are getting their contributions. How these legislators then vote will influence policy changes perhaps in the favor of those who are giving. Make youself a more informed voter by following the money.</p>
